...
const sheetUrl = "https://docs.google.com/spreadsheets/d/1m88zDValNIfP_tK-tBZKFuo-YGRTCHvvho_BIz1yEF0";
...
<body>
  ...
  <script>
    ...
    function buildMonthlyFrames(sourceFrames) {
    ...
    function updateRangeMeta() {
      ...
      const cadence = playbackMode === "smooth" ? "monthly frames" : "capture frames";
    ...
    function setPlaybackMode(mode, targetDate) {
      playbackMode = mode;
      frames = playbackMode === "smooth" ? buildMonthlyFrames(rawFrames) : rawFrames;
    ...
    function renderFrame(nextIndex) {
      ...
      sourceMeta.textContent = frame.sourceDate && frame.sourceDate !== frame.date
