...
- Generated: 2026-07-04T05:44:39Z
- Target games: 32
- Status filter: none
...
- CDX status counts: failed=10, fetched=21
- CDX rows found: 0
- Candidates with CDX rows: 0
- Payloads with count-like signals: 0
- Parsed play-count rows: 0
- Deduped recovered play-count observations: 868 (0 new this run)
- Accumulated probe-history rows: 20048 (21 new, 10 refreshed)
...
10 CDX lookups failed during this run, so dry endpoints with failed status should be retried later before being treated as durable absences.
