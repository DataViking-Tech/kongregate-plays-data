...
- HIGH metrics/catalog_games_without_metrics_history: 1280 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
...
- LOW plays/stale_listing_play_count_observations: 123 - Kept as raw observations, but excluded from true decrease counts because the value repeats an older listing count.
