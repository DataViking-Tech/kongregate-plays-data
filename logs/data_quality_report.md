...
- MEDIUM coverage/months_without_ranked_captures: 24 - Fetch additional CDX captures for ranked/listing pages, prioritizing long empty stretches.
...
- HIGH metrics/catalog_games_need_page_history: 2550 - Continue per-game metrics history backfill.
