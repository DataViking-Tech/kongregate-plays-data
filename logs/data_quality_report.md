...
- HIGH metrics/catalog_games_without_metrics_history: 274 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
...
- Skrillex Equinox Launchpad v2.0 (score 2951, best rank 5, metrics rows 0)
