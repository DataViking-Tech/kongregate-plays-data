...
- HIGH metrics/catalog_games_without_metrics_history: 464 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
...
- Cursed Treasure (score 3153, best rank 3, metrics rows 0)
