...
- Run timestamp: 2026-06-30T07:35:37Z
- As of: 2026-06-30
- Ranked rows: 36709
- Ranked rows with play counts: 11087
- Ranked date range: 2007-01-20 to 2026-06-26
- Mini catalog games: 3037
- Metrics history rows/games: 6444 / 2278
- Metrics date range: 2013-09-18 to 2026-06-30
- Invalid cached HTML files: 0

## Top Issues

- MEDIUM coverage/months_without_ranked_captures: 59 - Fetch additional CDX captures for ranked/listing pages, prioritizing long empty stretches.
- HIGH metrics/catalog_games_without_metrics_history: 316 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
- HIGH metrics/catalog_games_need_page_history: 2341 - Continue per-game metrics history backfill.
- LOW dedupe/duplicate_ranked_rows: 3457 - Review duplicate key handling by date/source/rank/game.
- MEDIUM identity/games_with_multiple_url_variants: 361 - Use canonical URL keys for joins and charting; consider canonicalizing processed rows.
- MEDIUM plays/play_count_decreases: 1 - Review source-specific decreases; chart uses max observed counts but raw rows need QA labels.
