...
- HIGH metrics/catalog_games_need_page_history: 2294 - Continue per-game metrics history backfill.
- LOW dedupe/duplicate_ranked_rows: 3141 - Review duplicate key handling by date/source/rank/game.
- MEDIUM identity/games_with_multiple_url_variants: 344 - Use canonical URL keys for joins and charting; consider canonicalizing processed rows.

## Top Metrics Backfill Priorities

- Unpuzzle 2 (score 3369, best rank 1, metrics rows 0)
