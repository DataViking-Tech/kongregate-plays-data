...
- HIGH metrics/catalog_games_without_metrics_history: 295 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
- HIGH metrics/catalog_games_need_page_history: 768 - Continue per-game metrics history backfill.
- LOW dedupe/duplicate_ranked_rows: 931 - Review duplicate key handling by date/source/rank/game.
- MEDIUM identity/games_with_multiple_url_variants: 267 - Use canonical URL keys for joins and charting; consider canonicalizing processed rows.
