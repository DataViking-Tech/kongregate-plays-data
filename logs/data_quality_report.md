...
- HIGH metrics/catalog_games_without_metrics_history: 380 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
- HIGH metrics/catalog_games_need_page_history: 865 - Continue per-game metrics history backfill.
- LOW dedupe/duplicate_ranked_rows: 1314 - Review duplicate key handling by date/source/rank/game.
