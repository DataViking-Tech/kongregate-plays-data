...
- Run timestamp: 2026-06-29T23:23:50Z
- As of: 2026-06-29
- Ranked rows: 28389
- Ranked rows with play counts: 8963
- Ranked date range: 2007-01-20 to 2026-06-26
- Mini catalog games: 2909
...
- MEDIUM coverage/months_without_ranked_captures: 75 - Fetch additional CDX captures for ranked/listing pages, prioritizing long empty stretches.
- HIGH metrics/catalog_games_without_metrics_history: 1288 - Sweep metrics.json histories by catalog chunks using --catalog-offset/--catalog-limit.
- HIGH metrics/catalog_games_need_page_history: 2230 - Continue per-game metrics history backfill.
- LOW dedupe/duplicate_ranked_rows: 2615 - Review duplicate key handling by date/source/rank/game.
- MEDIUM identity/games_with_multiple_url_variants: 326 - Use canonical URL keys for joins and charting; consider canonicalizing processed rows.

## Top Metrics Backfill Priorities

- Unpuzzle 2 (score 3363, best rank 1, metrics rows 0)
