...
- Per-game metrics history rows: 1,645 across 109 canonical games
- Observed play-count rows used by the chart: 6,330
...
- 572 mini-catalog games still need per-game metrics history backfill.
