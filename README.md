...
- Per-game metrics history rows: 2,444 across 193 canonical games
- Observed play-count rows used by the chart: 7,129
...
- 444 mini-catalog games still need per-game metrics history backfill.
