...
- Per-game metrics history rows: 1,940 across 148 canonical games
- Observed play-count rows used by the chart: 6,625
...
- 511 mini-catalog games still need per-game metrics history backfill.
