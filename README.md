...
- Per-game metrics history rows: 2,655 across 218 canonical games
- Observed play-count rows used by the chart: 7,340
...
- 405 mini-catalog games still need per-game metrics history backfill.
