...
- Per-game metrics history rows: 2,067 across 162 canonical games
- Observed play-count rows used by the chart: 6,752
...
- 493 mini-catalog games still need per-game metrics history backfill.
