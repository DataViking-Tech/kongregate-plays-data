...
- Per-game metrics history rows: 1,842 across 133 canonical games
- Observed play-count rows used by the chart: 6,527
...
- 534 mini-catalog games still need per-game metrics history backfill.
