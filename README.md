...
- Per-game metrics history rows: 1,551 across 106 canonical games
- Observed play-count rows used by the chart: 6,236
...
- 577 mini-catalog games still need per-game metrics history backfill.
