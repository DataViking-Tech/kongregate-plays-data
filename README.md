...
- Per-game metrics history rows: 1,333 across 84 canonical games
- Observed play-count rows used by the chart: 6,018
...
- 610 mini-catalog games still need per-game metrics history backfill.
