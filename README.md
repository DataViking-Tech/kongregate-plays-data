...
https://docs.google.com/spreadsheets/d/1p8m-jJ09G74JRlt96ZUJwe7g76vR8Ox9tPY0j0CGTmc

## Current Snapshot

- Ranked-list rows: 15,833
- Ranked-list rows with observed play counts: 7,154
- Mini catalog: 1,644 games that reached top 20 in observed rankings
- Per-game metrics history rows: 4,466 across 929 canonical games
- Observed play-count rows used by the chart: 11,620
...
- 406 mini-catalog games still have no per-game metrics rows, and 1,206 still need deeper page-history backfill.
- Metrics gap audit currently has 0 fresh pending captures and 235 missing CDX cache files; remaining unresolved games include 232 no-CDX cases, 146 CDX-cache-missing cases, and 28 games with known failures only.
