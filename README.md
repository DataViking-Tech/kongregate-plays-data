...
- Per-game metrics history rows: 1,433 across 98 canonical games
- Observed play-count rows used by the chart: 6,118
...
- 587 mini-catalog games still need per-game metrics history backfill.
