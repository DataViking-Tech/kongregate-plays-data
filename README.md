...
https://docs.google.com/spreadsheets/d/1Td9twlAleNCrt2CUykDcxn-XuEKHMDi6bwtotS8zLZI

## Current Snapshot

- Ranked-list rows: 30,935
- Ranked-list rows with observed play counts: 9,943
- Mini catalog: 2,938 games that reached top 20 in observed rankings
...
- 73 historical months still have no ranked-list captures in the processed dataset.
- 1,314 mini-catalog games still have no per-game metrics rows, and 2,242 still need deeper page-history backfill.
