...
https://docs.google.com/spreadsheets/d/18v8HCKAH5q1nTNyhh8odQPBLcoMgBaCDk3hrjbJkFa8
...
- Per-game metrics history rows: 5,053 across 1,286 canonical games
- Observed play-count rows used by the chart: 16,140
- Chart playback: Smooth mode uses 2,331 interpolated display frames by default; Captures mode exposes all 1,801 observed capture-date frames.
...
- Metrics gap audit currently has 0 fresh pending captures and 714 missing CDX cache files; remaining unresolved games include 633 no-CDX cases, 626 CDX-cache-missing cases, and 49 games with known failures only.
