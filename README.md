...
- Per-game metrics history rows: 2,184 across 169 canonical games
- Observed play-count rows used by the chart: 6,869
...
- 481 mini-catalog games still need per-game metrics history backfill.
