...
- Per-game metrics history rows: 2,556 across 206 canonical games
- Observed play-count rows used by the chart: 7,241
...
- 424 mini-catalog games still need per-game metrics history backfill.
