...
- Per-game metrics history rows: 1,015 across 50 canonical games
- Observed play-count rows used by the chart: 5,700
...
- 659 mini-catalog games still need per-game metrics history backfill.
