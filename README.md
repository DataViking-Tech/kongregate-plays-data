...
https://docs.google.com/spreadsheets/d/1YNoN10C0mw_ecA9JPdmsjhusy3JD6ABrGW9tOfyAlUo
...
- Per-game metrics history rows: 7,199 across 2,569 canonical games
- Observed play-count rows used by the chart: 21,717
- Chart playback: Smooth mode uses 7,457 interpolated month-paced display frames by default; Captures mode exposes all 2,128 observed capture-date frames.
...
- Metrics gap audit currently has 0 fresh pending captures, 277 known failed archived captures, 367 unresolved no-CDX cases, 71 missing CDX cache files noted for targeted follow-up, and 0 known-failures-only cases.
