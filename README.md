...
- Per-game metrics history rows: 3,265 across 308 canonical games
- Observed play-count rows used by the chart: 7,950
...
- 302 mini-catalog games still need per-game metrics history backfill.
