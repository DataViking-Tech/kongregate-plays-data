...
- Per-game metrics history rows: 3,329 across 313 canonical games
- Observed play-count rows used by the chart: 8,014
...
- 297 mini-catalog games still need per-game metrics history backfill.
