...
- Per-game metrics history rows: 2,264 across 179 canonical games
- Observed play-count rows used by the chart: 6,949
...
- 464 mini-catalog games still need per-game metrics history backfill.
