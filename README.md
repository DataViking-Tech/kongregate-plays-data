...
https://docs.google.com/spreadsheets/d/1dVogsuHwa9PlQzr7shMx2j3IDDnheN1v0St3qGtOyko
...
- Per-game metrics history rows: 7,077 across 2,569 canonical games
- Observed play-count rows used by the chart: 21,595
- Chart playback: Smooth mode uses 3,729 interpolated month-paced display frames by default; Captures mode exposes all 2,109 observed capture-date frames.
...
- Metrics gap audit currently has 0 fresh pending captures, 361 known failed archived captures, 367 unresolved no-CDX cases, 104 missing CDX cache files noted for targeted follow-up, and 0 known-failures-only cases.
