...
python3 scripts/fetch_game_page_history.py --input-csv data/processed/catalog_history_priorities.csv --tiers 1 --metrics-row-status no_metrics --profile-offset 53 --profile-limit 25 --max-cdx-games 25 --variant-limit 2 --max-fetches 120 --max-jobs-per-game 10 --cdx-timeout 6
