...
- Per-game metrics history rows: 2,855 across 247 canonical games
- Observed play-count rows used by the chart: 7,540
...
- 370 mini-catalog games still need per-game metrics history backfill.
