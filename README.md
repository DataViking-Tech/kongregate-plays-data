...
- Per-game metrics history rows: 2,004 across 151 canonical games
- Observed play-count rows used by the chart: 6,689
...
- 507 mini-catalog games still need per-game metrics history backfill.
