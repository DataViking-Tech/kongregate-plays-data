...
https://docs.google.com/spreadsheets/d/1igEJLyR920UO4n4vSWyvjkvDen2LVdg2CTlVnlwL08o
...
- Per-game metrics history rows: 4,913 across 1,281 canonical games
- Observed play-count rows used by the chart: 16,000
- Chart playback: Smooth mode uses 2,331 interpolated display frames by default; Captures mode exposes all 1,790 observed capture-date frames.
...
- 1,316 mini-catalog games still have no per-game metrics rows, and 2,311 still need deeper page-history backfill.
- Metrics gap audit currently has 0 fresh pending captures and 769 missing CDX cache files; remaining unresolved games include 603 no-CDX cases, 670 CDX-cache-missing cases, and 43 games with known failures only.
