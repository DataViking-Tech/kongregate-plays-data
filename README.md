...
- Per-game metrics history rows: 2,949 across 255 canonical games
- Observed play-count rows used by the chart: 7,634
...
- 360 mini-catalog games still need per-game metrics history backfill.
