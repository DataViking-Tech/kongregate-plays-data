...
https://docs.google.com/spreadsheets/d/1VSwmZITNg_Xx0FIz4btfvmFiEe2q7k_8by3nCTEp9pw
...
- Per-game metrics history rows: 7,027 across 2,569 canonical games
- Observed play-count rows used by the chart: 21,545
- Chart playback: Smooth mode uses 3,729 interpolated month-paced display frames by default; Captures mode exposes all 2,101 observed capture-date frames.
...
- Metrics gap audit currently has 0 fresh pending captures, 359 known failed archived captures, 367 unresolved no-CDX cases, 191 missing CDX cache files noted for targeted follow-up, and 0 known-failures-only cases.
