...
- Per-game metrics history rows: 1,720 across 122 canonical games
- Observed play-count rows used by the chart: 6,405
- Ranked-list date range: 2007-01-20 to 2026-06-26
- Metrics-history date range: 2013-09-18 to 2025-10-25
...
- 552 mini-catalog games still need per-game metrics history backfill.
