...
- Per-game metrics history rows: 2,348 across 184 canonical games
- Observed play-count rows used by the chart: 7,033
...
- 457 mini-catalog games still need per-game metrics history backfill.
