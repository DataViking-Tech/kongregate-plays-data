...
- Per-game metrics history rows: 1,910 across 139 canonical games
- Observed play-count rows used by the chart: 6,595
...
- 525 mini-catalog games still need per-game metrics history backfill.
