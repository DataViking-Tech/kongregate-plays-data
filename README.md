...
- Per-game metrics history rows: 2,739 across 226 canonical games
- Observed play-count rows used by the chart: 7,424
...
- 396 mini-catalog games still need per-game metrics history backfill.
