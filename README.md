...
- Per-game metrics history rows: 2,039 across 155 canonical games
- Observed play-count rows used by the chart: 6,724
...
- 500 mini-catalog games still need per-game metrics history backfill.
