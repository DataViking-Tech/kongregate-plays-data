...
https://docs.google.com/spreadsheets/d/1m88zDValNIfP_tK-tBZKFuo-YGRTCHvvho_BIz1yEF0

## Current Snapshot

- Ranked-list rows: 13,813
- Ranked-list rows with observed play counts: 7,154
- Mini catalog: 1,303 games that reached top 20 in observed rankings
...
- 380 mini-catalog games still have no per-game metrics rows, and 865 still need deeper page-history backfill.
- Metrics gap audit currently has 0 fresh pending captures and 149 missing CDX cache files; remaining unresolved games are 194 no-CDX cases and 37 games with known failures only.
