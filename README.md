...
- Per-game metrics history rows: 1,781 across 127 canonical games
- Observed play-count rows used by the chart: 6,466
- Ranked-list date range: 2007-01-20 to 2026-06-26
- Metrics-history date range: 2013-09-18 to 2025-10-29
...
- 543 mini-catalog games still need per-game metrics history backfill.
